...
public class Constant {
	...
	public static final String textFormat_404 =
            "<html><head><title>Tomcat AIR/1.0.1 - Error report</title><style>" +
            ...
            "<u>The requested resource is not available.</u></p><HR size='1' noshade='noshade'><h3>Tomcat AIR 1.0.1</h3>" +
            "</body></html>";
